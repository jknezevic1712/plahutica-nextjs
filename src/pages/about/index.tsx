          ...
          <div className="flex h-[50%] w-[85%] justify-center py-10">
            <div className="flex h-full w-full flex-col items-center text-justify leading-6 lg:w-4/5 3xl:w-2/3">
              ...
              <p className="w-full break-words pb-24 text-justify indent-6 leading-8 md:text-xl md:leading-9 2xl:text-2xl 2xl:leading-10">
                ...
                savjetima. S obzirom na to da sam studentica trudim se što više
                uštedjeti na putovanjima, a s druge strane vidjeti i doživjeti
                što više toga pa je zato ovaj blog idealan za svakog tko putuje
                s nešto manjim budžetom.
              </p>
              <p className="w-full break-words text-justify indent-6 leading-8 md:text-xl md:leading-9 2xl:text-2xl 2xl:leading-10">
                ...
                izradu i dizajn ovog bloga. Osim toga, volim učiti nove stvari,
                putovati te proučavati nove tehnologije i programske jezike kako
                bih se razvijao i napredovao. Nadam se da će vam blog biti
                koristan i da ćete uživati u čitanju!
              </p>
            </div>
          </div>
